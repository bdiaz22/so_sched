...
static void enqueue_task_fifo(struct rq *rq, struct task_struct *p, int flags){}
static void dequeue_task_fifo(struct rq *rq, struct task_struct *p, int flags){}
static void yield_task_fifo(struct rq *rq){}
static bool yield_to_task_fifo(struct rq *rq, struct task_struct *p, bool preempt){}
static bool yield_to_task_fifo(struct rq *rq, struct task_struct *p, bool preempt){}
...
static int select_task_rq_fifo(struct task_struct *p, int prev_cpu, int sd_flag, int wake_flags){}
static void migrate_task_rq_fifo(struct task_struct *p, int new_cpu){}

static void rq_online_fifo(struct rq *rq){}
static void rq_offline_fifo(struct rq *rq){}

static void task_dead_fifo(struct task_struct *p){}

static void set_curr_task_fifo(struct rq *rq){}
static void task_tick_fifo(struct rq *rq, struct task_struct *curr, int queued){}
static void task_fork_fifo(struct task_struct *p){}

static void prio_changed_fifo(struct rq *rq, struct task_struct *p, int oldprio){}
static void switched_from_fifo(struct rq *rq, struct task_struct *p){}
static void switched_to_fifo(struct rq *rq, struct task_struct *p){}

static unsigned int get_rr_interval_fifo(struct rq *rq, struct task_struct *task){}

static void update_curr_fifo(struct rq *rq){}

const struct sched_class fifo_sched_class = {
